...
function handleLogout() {
  ...
  return (
    ...
    <div className="px-2 lg:px-10 flex justify-between items-center">
        ...
        <ul className="menu-item hidden lg:flex text-sm ml-44 whitespace-nowrap space-x-2">
            <li><Link to="discover" className="top-nav-link tracking-wider px-2 hover:text-syellow hover:border-b-4 hover:border-syellow pb-3 font-bold">Discover</Link></li>
            <li><Link to="my-bookings" className="top-nav-link tracking-wider px-2 hover:text-syellow hover:border-b-4 hover:border-syellow pb-3 font-bold">My Bookings</Link></li>
            <li><Link to="tour-packages" className="top-nav-link tracking-wider px-2 hover:text-syellow hover:border-b-4 hover:border-syellow pb-3 font-bold">Tour Packages</Link></li>
        </ul>
